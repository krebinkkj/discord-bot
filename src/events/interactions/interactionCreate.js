...
module.exports = async (client, interaction) => {
  if (!interaction.guild) {
    return interaction
      .reply({ content: "O comando só pode ser executado em um servidor discord", ephemeral: true })
      .catch(() => {});
  }
  ...
  // Context Menu
    ...
    else return interaction.reply({ content: "Ocorreu um erro", ephemeral: true }).catch(() => {});
  }
